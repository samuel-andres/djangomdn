    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_back', models.DateField(blank=True, null=True, verbose_name='Expected date of availability')),
                ('status', models.CharField(blank=True, choices=[('m', 'Maintenance'), ('o', 'On loan'), ('a', 'Avaible'), ('r', 'Reserved')], default='m', help_text='Book availability', max_length=1)),
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, related_name='get_copies', to='catalog.book')),
            ],
            options={
                'ordering': ['due_back'],
            },
